...
public class ReadingCsvFile {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //For reading file
        FileReader fileReader = new FileReader("F:\\Intern\\DocumentsForIntern\\Mock_Flight_data1.csv");
...
//        printing(hashMap);
        ...
        for (Map.Entry<String, ArrayList<FlightInfo>> st1 : str.entrySet()) {
            ...
            FileWriter fileWriter = new FileWriter("F:\\Intern\\DocumentsForIntern\\FlightData\\" + st1.getKey() + ".csv");
