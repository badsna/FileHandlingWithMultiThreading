...
public class WritingCSVFile {
    public static void main(String[] args) {
        ...
        try{
            FileReader fileReader=new FileReader("F:\\Intern\\DocumentsForIntern\\Mock_Flight_data.csv");
            BufferedReader bufferedReader=new BufferedReader(fileReader);

            FileWriter fileWriter=new FileWriter("F:\\Intern\\DocumentsForIntern\\Mock_Flight_data1.csv");
